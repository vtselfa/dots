-- Override vim.ui.input with a custom function
--
-- original by tLaw101:
...
local function wininput(opts, on_confirm, win_opts)
    ...
    -- for prompt + default text plus some right padding
    local right_padding = 25
    win_opts.width = #default_text + #prompt + right_padding < win_opts.width
        and win_opts.width
        or #default_text + #prompt + right_padding
